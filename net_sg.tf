resource "yandex_vpc_security_group" "app_sg" {
  ...
  egress {
    port           = 443
    protocol       = "TCP"
    v4_cidr_blocks = ["54.196.99.49/32", "34.226.69.105/32", "3.219.239.5/32", "104.16.100.207/32", "104.16.101.207/32", "104.16.102.207/32", "104.16.103.207/32", "104.16.104.207/32", "3.216.34.172/32", "44.205.64.79/32", "34.205.13.154/32", "3.228.146.75/32", "18.206.20.10/32", "18.210.197.188/32"]
  }
